...
def pasang():
    ...
    tema = open(".bashrc", 'w')
    tema.write("""
#Created By Ẅ̷̧̗́̄̌̔̈́̃̉̓̂̚Ä̵̹̝͖̫̼̫͍̟́͑̈́ͅN̶͇͔͔͙̥͗̽̑͒̅͌̊̀͝ͅZ̸̛̻̞͈͍̩̋̊̈́̓̏́̈́͝͝O̴̤̦̓̀̌͊̀̏̈͌F̸̛̦͌C̶̛̥̹̖̊͛̄̆̀
clear
echo "
\033[31;1m█████████████████   \033[37;1m[\033[41;1mẄ̷̧̗́̄̌̔̈́̃̉̓̂̚Ä̵̹̝͖̫̼̫͍̟́͑̈́ͅN̶͇͔͔͙̥͗̽̑͒̅͌̊̀͝ͅZ̸̛̻̞͈͍̩̋̊̈́̓̏́̈́͝͝O̴̤̦̓̀̌͊̀̏̈͌F̸̛̦͌C̶̛̥̹̖̊͛̄̆̀ CYBER INDONESIA\033[00;1m\033[37;1m]
\033[31;1m█████████████████
...
"""% nama)
    ...
    print("\n\033[42;1mJangan Lupa Subscribe Channel wanzofc\033[00;1m")
...
def kembali():
    os.system("clear")
    exit("\033[34;1mJangan Lupa Subscribe Channel wanzofc:)")
main()
